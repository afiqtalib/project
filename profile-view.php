        ...
        <div class="row">
            <div class="col">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $_SESSION['email_system'];?></li>
                </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            <img src="https://source.unsplash.com/featured?technology/200x200" alt="avatar"
                            ...
                            <div class="d-flex justify-content-center mb-2">
                                ...
                                <a href="profile.php?admin_id=<?php echo $admin['admin_id']; ?> " class="btn btn-outline-primary ms-1">Update</a>
                            </div>
                        </div>
                    </div>
                </div>
