...
<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit_profile'])) {
        ...
        if ($query && move_uploaded_file($tempname, $folder)) {
            echo '<script type="text/javascript">sweetAlert("Success !"," Your profile has been updated","success")</script>';
            // echo "<script type='text/javascript'> document.location ='profile-view.php'; </script>";
        }
        else {   
            echo '<script type="text/javascript">sweetAlert("Error !"," Your profile has not been updated. Please Fill all information required ","error")</script>';        
        }
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <a href="profile.php" class="btn btn-warning btn-md">
